        ...
        <?php
            ...
            if($data->sections){
                ...
                foreach ($data->sections as $section){
                    echo "<li class=\"section\"><a href=\"api-section.php?website=$website&id=$section->id\"><strong>";
                    echo strip_tags($section->name, "<a>")."</strong></a></li>";
                    if($section->subsections){
                        echo "<ul class=\"sub_list\">";
                        foreach ($section->subsections as $sub){
                            echo "<li class=\"section\"><a href=\"api-section.php?website=$website&id=$sub->id\">";
                            echo strip_tags($sub->name, "<a>")."</a></li>";
                        }
                        echo "</ul>";
                    }
                }
            ...
            if($data->articles){
                ...
                foreach ($data->articles as $art){
                    echo "<li class=\"article\"><a href=\"api-topic.php?website=$website&id=$art->id\">";
                    echo strip_tags($art->title, "<a>")."</a>";
